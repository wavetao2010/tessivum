#!/usr/bin/env python3
"""Check current release claims against retained Alpha.23 benchmark evidence."""
...
def main() -> int:
    ...
    require(version == "0.1.0-alpha.30", f"unexpected package version: {version}")
    ...
    print(f"PASS: {version} release claims match retained Alpha.23 benchmark evidence")
    return 0

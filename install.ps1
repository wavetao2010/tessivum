...
function Show-Usage {
    [Console]::Error.WriteLine('usage: powershell -ExecutionPolicy Bypass -File .\install.ps1 <version> (or set VERSION)')
...
try {
    ...
    elseif (-not $Uninstall.IsPresent) {
        Fail 'No default Windows release is published. Pass an explicit version or set VERSION.'
    }

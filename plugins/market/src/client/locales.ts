...
export const zh = {
  ...
  restartBanner: '项变更完成，重启 Tessivum 后生效',
  uninstall: '卸载',
  confirmRemove: '确认卸载？',
  uninstalling: '卸载中…',
  uninstallConfirmDesc: '将从当前 profile 中移除该插件。',
  restartHint: '由 Tessivum 主机安全地重启。',
  confirmTitle: '安装',
  ...
  restartNow: '立即重启 Tessivum',
  autoRestart: '本队列完成后自动重启',
  autoRestartOn: '已启用自动重启',
  dismiss: '关闭提示',
  dismissNotice: '关闭此提示',
  restarting: '正在重启 Tessivum…',
  restartFail: 'Tessivum 重启失败',
  restartTimeout: '等待 Tessivum 启动超时',
  updateNow: '立即更新',
  updateFail: '更新失败',
  upToDate: '已是最新',
  linkedDev: '本地开发',
  ...
  toggleFail: '切换失败',
  deprecatedBadge: '已废弃',
  catalogOfficial: 'Tessivum 官方',
  catalogVerified: 'Tessivum 已验证 · {0}',
  catalogCommunity: 'DSH 社区 · 未验证',
  catalogRevoked: 'Tessivum 验证已撤销 · {0}',
  verificationNotAudit: '收录或验证不等同于安全审计；Legacy 插件将以你的用户权限运行。',
...
export const en: Record<MarketKey, string> = {
  ...
  restartBanner: 'change(s) done — restart Tessivum to apply',
  uninstall: 'Uninstall',
  confirmRemove: 'Uninstall?',
  uninstalling: 'Uninstalling…',
  uninstallConfirmDesc: 'This removes the plugin from the current profile.',
  restartHint: 'Tessivum restarts safely through its host lifecycle service.',
  ...
  restartNow: 'Restart Tessivum now',
  autoRestart: 'Restart automatically when this queue drains',
  autoRestartOn: 'Automatic restart enabled',
  dismiss: 'Dismiss',
  dismissNotice: 'Dismiss this notice',
  restarting: 'Restarting Tessivum…',
  restartFail: 'Tessivum restart failed',
  restartTimeout: 'Timed out waiting for Tessivum to start',
  ...
  catalogOfficial: 'Tessivum official',
  catalogVerified: 'Verified on Tessivum · {0}',
  catalogCommunity: 'DSH community · unverified',
  catalogRevoked: 'Tessivum verification revoked · {0}',
  verificationNotAudit: 'Listing or verification is not a security audit; Legacy plugins run with your user permissions.',

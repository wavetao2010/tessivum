...
`v0.1.0-alpha.23` 是预发布版本。它使用 `tessivum-core v0.1.6` 修订版 `ee50f646b96163cbcbf25835499f7d2d63883513`，兼容目标为 DeepSeek Harness `0.1.0-rc.5` 提交 `47f943859bef60e4160492346772ded9b24f765a`。

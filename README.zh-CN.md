...
`v0.1.0-alpha.23` 是预发布版本。它使用 `tessivum-core v0.1.6` 修订版 `3fe3391ccd35f3e6820dbd874b1eb0c5bc329eaf`，兼容目标为 DeepSeek Harness `0.1.0-rc.5` 提交 `47f943859bef60e4160492346772ded9b24f765a`。

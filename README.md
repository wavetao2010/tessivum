...
`v0.1.0-alpha.23` is a prerelease. It uses `tessivum-core v0.1.6` at revision `2a7f39006f7bde5b680405b2827f32d85ab20c26` and targets DeepSeek Harness `0.1.0-rc.5` at commit `47f943859bef60e4160492346772ded9b24f765a`.
